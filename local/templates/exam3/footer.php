<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
	...
	array(
		"ACTIVE_COMPONENT" => "Y"
                    ...
                    <!-- /side menu -->
                    <!-- side anonse -->
                    <?$APPLICATION->IncludeComponent("bitrix:main.include", "usefull_info", Array(
	...
	Array(
		...
		"CACHE_TIME" => "360000",
		"CACHE_TYPE" => "A",
		"COMPONENT_TEMPLATE" => "last_rew",
		"DETAIL_URL" => "",
		"FIELD_CODE" => array(0=>"NAME",1=>"PREVIEW_TEXT",2=>"PREVIEW_PICTURE",3=>"DATE_ACTIVE_FROM",4=>"PROPERTY_POSITION",5=>"PROPERTY_COMPANY",6=>"",),
		"IBLOCKS" => array(0=>"35",),
		"IBLOCK_TYPE" => "reviews",
		"NEWS_COUNT" => "2",
