<div class="site-section border-bottom">
 ...
 <img alt="Image" src="/local/templates/home/images/person_2.jpg" class="img-fluid">
			</div>
...
<div class="site-section border-bottom">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
 <img alt="Image" src="/local/templates/home/images/person_3.jpg" class="img-fluid">
			</div>
			<div class="col-md-5 ml-auto" data-aos="fade-up" data-aos-delay="200">
				<div class="site-section-title mb-3">
					<h2>Наш дизайнер</h2>
...
<div class="site-section border-bottom">
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
 <img alt="Image" src="/local/templates/home/images/person_4.jpg" class="img-fluid">
			</div>
			<div class="col-md-5 ml-auto" data-aos="fade-up" data-aos-delay="200">
				<div class="site-section-title mb-3">
					<h2>Наша агент</h2>
